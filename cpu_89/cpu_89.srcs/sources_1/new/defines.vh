...
//CP0
`define CP0_REG_COUNT    5'b01001        //锟缴讹拷写
`define CP0_REG_COMPARE    5'b01011      //锟缴讹拷写
`define CP0_REG_STATUS    5'b01100       //锟缴讹拷写
`define CP0_REG_CAUSE    5'b01101        //只锟斤拷
`define CP0_REG_EPC    5'b01110          //锟缴讹拷写
`define CP0_REG_PrId    5'b01111         //只锟斤拷
`define CP0_REG_CONFIG    5'b10000       //只锟斤拷